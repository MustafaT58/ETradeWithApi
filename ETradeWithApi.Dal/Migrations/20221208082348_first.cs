    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketMasters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasketMasters_Users_EntityId",
                        column: x => x.EntityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BasketDetails_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketDetails_UnitId",
                table: "BasketDetails",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketMasters_EntityId",
                table: "BasketMasters",
                column: "EntityId");
